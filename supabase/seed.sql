...
WITH inserted_classes AS (
  INSERT INTO classes (id, name, slug, game_day_threshold, pizza_day_threshold, lessons_per_week) VALUES
    ('11111111-0000-0000-0000-000000000001', '7А', '4827', 250, 500, 2),
    ('11111111-0000-0000-0000-000000000002', '7Б', '1593', 500, 800, 2),
    ('11111111-0000-0000-0000-000000000003', '7В', '7041', 250, 400, 2),
    ('11111111-0000-0000-0000-000000000004', '7Г', '9365', 500, 800, 2),
    ('11111111-0000-0000-0000-000000000005', '7Д', '2180', 500, 800, 2),
    ('11111111-0000-0000-0000-000000000006', '7Е', '6674', 350, 700, 2)
