...
WITH inserted_classes AS (
  INSERT INTO classes (id, name, slug, game_day_threshold, pizza_day_threshold, lessons_per_week) VALUES
    ...
    ('11111111-0000-0000-0000-000000000002', '7Б', '1593', 250, 350, 2),
    ('11111111-0000-0000-0000-000000000003', '7В', '7041', 100, 200, 2),
    ('11111111-0000-0000-0000-000000000004', '7Г', '9365', 200, 300, 2),
    ('11111111-0000-0000-0000-000000000005', '7Д', '2180', 200, 300, 2),
    ('11111111-0000-0000-0000-000000000006', '7Е', '6674', 200, 300, 2)
