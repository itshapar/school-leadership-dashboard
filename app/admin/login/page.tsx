...
function AdminLoginForm() {
  ...
  return (
    <AuthShell title="Вхід для вчителя" subtitle="Кабінет класів і журналу">
      ...
      {/* Туторіал і демо під формою (живий фідбек): до цього незалогінена
          людина бачила тільки вхід, реєстрацію й відновлення пароля, тобто
          ні подивитись, ні спробувати продукт до реєстрації було ніде. */}
      <DemoEntryCard />
