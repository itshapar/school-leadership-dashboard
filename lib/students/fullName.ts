...
/**
 * Один рядок замість двох підказок з іконками під полем ПІБ (живий фідбек,
 * 9.23) — порядок слів тут навмисно лишається (не лише мінімізація даних):
 * без нього публічний fallback (коментар вище) віддасть прізвище замість
 * імені при неправильному порядку введення.
 */
export const FULL_NAME_COMBINED_HINT =
  "Пишіть лише прізвище та ім'я, у такому порядку: спершу прізвище. Жодних інших персональних даних вносити не потрібно.";
